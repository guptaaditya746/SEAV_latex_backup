...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{img/result/tf_tree.jpg}  % Replace with actual image
    \caption{tf tree, show parent and child connection, used by ros transformation}
