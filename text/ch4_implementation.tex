...
\begin{itemize}
    ...
    \item Color Sensors (TCS 34725): One sensor positioned near a rear wheel for speed or distance estimation, the other near the front for steering feedback. The placement of color sensor on the steering wheel involves more work, which is explained ..... %% add vinays content here.
